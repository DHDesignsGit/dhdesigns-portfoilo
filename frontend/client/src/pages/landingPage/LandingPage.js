...
import img1 from "../../media/downloadedSvgs/working-with-laptop.svg"
import img2 from "../../media/downloadedSvgs/logistics.svg"
...
const LandingPage = () => {
    ...
    <div className="animated-right" loading="lazy"><img src={ img1 } alt="" /></div>
    </div>
    <div className="section">
    ...
    <div className="animated-right">
        ...
        <p>Dělám moderní minimalistický design, který je nejen příjemný na oko, ale zapůsobí jak na mladou generaci, tak na dříve narozené, kteří nebudou mít problém se na vašich stránkách zorientovat.</p>
